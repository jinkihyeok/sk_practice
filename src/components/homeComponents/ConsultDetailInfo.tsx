            ...
            <div className="flex justify-center items-start p-2 text-xs bg-gray-200">
                <div className="flex flex-col gap-1 w-1/2">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <div className="w-3/4">
                            <input
                                type="text"
                                className="input-style text-center w-1/2"
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <div className="w-3/4">
                            ...
                            <input type="text" className="input-style text-center w-1/2" value={consultationDetail?.os} readOnly />
                        </div>
                    </div>
                    <div className="flex flex-row gap-1">
                ...
                <div className="flex flex-col gap-1 w-1/2">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <input type="text" className="input-style w-3/4" value={consultationDetail?.planName} readOnly />
                    </div>
                    <div className="flex flex-row gap-1">
                        <h3 className="w-1/4 text-end">이용종류</h3>
                        <input type="text" className="input-style text-center w-3/4" value={consultationDetail?.usageType} readOnly />
                    </div>
                    <div className="flex flex-row gap-1">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <input type="text" className="input-style text-center w-3/4" value={consultationDetail?.isMinor} readOnly />
                    </div>
                    <div className="flex flex-row gap-1">
                        <h3 className="w-1/4 text-end">법정대리인</h3>
                        <input type="text" className="input-style w-3/4" value={consultationDetail?.legalGuardian} readOnly />
                    </div>
