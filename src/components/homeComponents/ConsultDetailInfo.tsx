                ...
                <div className="flex flex-col gap-1 w-1/2">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <div className="w-3/4">
                            <input
                                type="text"
                                className="disabled-input-style text-center w-1/2"
                                value={consultationDetail?.subscriptionDate}
                                readOnly
                            />
                            <input type="text" className="disabled-input-style w-1/2" value={consultationDetail?.cancellationDate} readOnly />
                        </div>
                    </div>
                    <div className="flex flex-row gap-1">
                ...
                <div className="flex flex-col gap-1 w-1/2">
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <div className="w-3/4 flex flex-row">
                            ...
                            <input type="text" className="disabled-input-style w-1/5" value={consultationDetail?.simFirstNumber} readOnly />
                            <input type="text" className="disabled-input-style w-2/5" value={consultationDetail?.simSecondNumber} readOnly />
                        </div>
                    </div>
                    <div className="flex flex-row gap-1">
